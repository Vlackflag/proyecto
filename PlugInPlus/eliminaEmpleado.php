              ...
              <?php if ($rol == 1) { ?>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item disabled" href="eliminaEmpleado.php">Elimina empleado</a>
                  </div>
                </li>
                <!-- administrador -->
              <?php } ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link disabled">Eliminar empleado</a>
              </li>
            </ul>
          </div>
				...
				<div class="col-12">
					<div class="contact_form">
						<div class="formulario">      
							<h1 class="h1">Ingrese los datos del perfil actual, para eliminarlo.</h1>
							<form action="eliminarPerfilA.php" method="POST">
								<p class="p">
									<label class="label" for="matricula">Matricula.
										<span class="span">*</span>
									</label>
									<input class="input" <?php if ($matricula != "") {echo "value='".$matricula."'";}?> type="matricula" name="matricula" id="matricula" required="" placeholder="Escribe la matricula actual del empleado">
								</p>
