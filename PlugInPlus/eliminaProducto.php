							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<?php if ($rol == 1 or $rol == 2) { ?>
										...
										<a class="dropdown-item disabled" href="eliminaProducto.php">Eliminar producto</a>
										<!-- empleado --> 
									<?php } ?>
				...
				<nav class="navbar navbar-expand-lg navbar-dark">
					...
					<div class="collapse navbar-collapse " id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto ">
							...
							<li class="nav-item">
								<a class="nav-link disabled">Eliminar producto</a>
							</li>
						</ul>
					</div>
			...
			<div class="col-12">
				<div class="contact_form">
					<div class="formulario">      
						<h1 class="h1">Ingrese los datos del producto a eliminar.</h1>
						<form action="eliminaProductoA.php" method="POST">
							<p class="p">
