			...
			<div class="col-12 mr-auto">
				<nav class="navbar navbar-expand-lg navbar-dark">
					...
					<div class="collapse navbar-collapse " id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto ">
							<li class="nav-item">
								<a class="nav-link disabled">Gestion del inventario</a>
							</li>
						</ul>
					</div>
...
<div class="container-fluid text-white text-center">
	<div class="row justify-content-center">
		<div class="col-sm-8 col-md-4 col-lg-5 align-self-center">
			<a type="button" class="btn btn-dark texto margin alto" href="venta.php"><img style="margin-top: 10px;" src="img/venta.png" width="20%"></br>Registrar venta</a>
		</div>
	</div>
	<?php if ($rol==1 or $rol==2) { ?>
	<div class="row justify-content-center">
		<div class="col-sm-8 col-md-4 col-lg-5 align-self-center">
			<a type="button" class="btn btn-dark texto margin alto" href="registrarNuevoProducto.php"><img style="margin-top: 10px;" src="img/nuevoProducto.png" width="20%"></br>Registrar nuevo producto.</a>
		</div>
	</div>
	<div class="row justify-content-center">
		<div class="col-sm-8 col-md-4 col-lg-5 align-self-center">
			<a type="button" class="btn btn-dark texto margin alto" href="actualizaProducto.php"><img style="margin-top: 10px;" src="img/actualizar.png" width="20%"></br>Actualizar producto.</a>
		</div>
	</div>
	<div class="row justify-content-center">
		<div class="col-sm-8 col-md-4 col-lg-5">
			<center><a type="button" class="btn btn-dark texto margin alto" href="eliminaProducto.php"><img style="margin-top: 10px;" src="img/eliminar.png" width="20%"></br>Eliminar producto.</a></center>
		</div>
	</div>
<?php } ?>
</div>
