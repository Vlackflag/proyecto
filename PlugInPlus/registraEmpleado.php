              ...
              <?php if ($rol == 1) { ?>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item disabled" href="registraEmpleado.php">Registrar empleado</a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link disabled">Registra nuevo empleado</a>
              </li>
            </ul>
          </div>
      ...
      <div class="col-12">
        <div class="contact_form">
          <div class="formulario">      
            <h1 class="h1">Complete los campos del empleado nuevo</h1>
            <form action="registraEmpleadoA.php" method="POST" enctype="multipart/form-data">
              <p class="p">
              ...
              <p class="p">
                <label class="label" for="apellidoPa">Apellido Paterno.
                  <span class="span">*</span>
                </label>
              ...
              <p class="p">
                <label class="label" for="apellidoMa">Apellido materno.
                  <span class="span">*</span>
                </label>
              ...
              <p class="p">
                <label class="label" for="password">Verifica la password
                  <span class="span">*</span>
                </label>
